...
class MySQL {
	...
	* *******************/
	...
	function MySQL($database, $username, $password, $prefix='', $hostname='localhost'){
	...
	* ******************/
	...
	function ArrayResult($output='object'){
		$this->arrayedResult = mysql_fetch_assoc($this->result) or die (mysql_error($this->databaseLink));
		return (object)$this->arrayedResult;
	}

	// 'Arrays' multiple result
	function ArrayResults($output='object'){
